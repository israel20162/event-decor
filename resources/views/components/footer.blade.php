        ...
        <div class="grid md:grid-cols-4 gap-x-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-300">
                    ...
                    <li><a href="/packages" class="hover:text-white">Services</a></li>
                    <li><a href="/about" class="hover:text-white">Portfolio</a></li>
            ...
            <div>
                ...
                <ul class="flex space-x-4 text-gray-300">
                    ...
                    <li><a href="#" class="hover:text-white"><i class="fab fa-linkedin-in"></i></a></li>
                </ul>
            </div>
        </div>
