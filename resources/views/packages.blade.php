    ...
    <div class="container mx-auto py-20 px-4 md:px-0">
        ...
        <div class="bg- rounded-lg shadow-md mt-16 p-8" id="booking-form">
            ...
            <form action="{{route('booking.create')}}" method="POST">
                ...
                <div class="bg- rounded-lg shadow-md mt- p-8 max-w-2xl mx-auto" id="booking-form">
 ...
 @if ($errors->any())
            ...
            @endif
                    ...
                    <div>
                        ...
                        <input type="text" id="fullName" name="name" class="w-full p-3 border rounded-md"
                            required>
                    </div>
                    ...
                    <!-- Preferred Package -->
                    <div>
                        <label for="package" class="block text-sm font-medium text-gray-600 mb-2">Preferred
                            Package</label>
                    ...
                    <div>
                        ...
                        <input type="date" id="eventDate" name="event_date" class="w-full p-3 border rounded-md">
                    </div>

                    <!-- Additional Notes or Requirements -->
                    <div>
                        <label for="notes" class="block text-sm font-medium text-gray-600 mb-2">Additional
                            Notes</label>
